import { fileURLToPath } from "url"; import path from "path"; import baileys, { downloadMediaMessage } from "baileys"; import { resolveLidToJid, getGroupMetadata } from "./lid.js"; import { getConfig } from "./filewatcher.js"; import { plugins, listeners } from "./plugin.js";
...
const groupMeta = m.isGroup ? getGroupMetadata(m.from) : null;
...
m.participant = rawParticipant
  ? resolveLidToJid(rawParticipant, groupMeta)
  : (m.isGroup ? sock.user.id : null);
...
if (contextInfo.quotedMessage) {
    ...
    quoted.key = { 
        remoteJid: m.from, 
        id: quoted.id, 
        fromMe: quoted.sender === sock.user.id, 
...
if (message?.pollCreationMessageV3) {
    m.poll = { 
        ...
        selectableOptionsCount: message.pollCreationMessageV3.selectableOptionsCount 
    };
}
